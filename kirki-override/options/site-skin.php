...
AGENCIES_Kirki::add_section( 'dt_site_skin_section', array(
	'title' => __( 'Site Skin', 'agencies' ),
	'priority' => 23
) );
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Predefined Skin ?', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 1,
		'default'  => agencies_defaults('use-predefined-skin' ),
		'choices'  => array(
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Skin', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'default' => agencies_defaults('predefined-skin' ),
		'multiple' => 1,
		'priority' => 2,
		...
		'choices' => array(
			'blue'			=>	esc_attr__('Blue','agencies'),
			'brown'			=>	esc_attr__('Brown','agencies'),
			'cadetblue'		=>	esc_attr__('Cadet Blue','agencies'),
			'chilipepper'	=>	esc_attr__('Chili Pepper','agencies'),
			'cyan'			=>	esc_attr__('Cyan','agencies'),
			'darkgolden'	=> 	esc_attr__('Dark Golden','agencies'),
			'deeporange'	=>	esc_attr__('Deep Orange','agencies'),
			'deeppurple'	=>	esc_attr__('Deep Purple','agencies'),
			'green'			=>	esc_attr__('Green','agencies'),
			'lime'			=>	esc_attr__('Lime','agencies'),
			'magenta'		=>	esc_attr__('Magenta','agencies'),
			'orange'		=>	esc_attr__('Orange','agencies'),
			'pink'			=>	esc_attr__('Pink','agencies'),
			'purple'		=>	esc_attr__('Purple','agencies'),
			'red'			=>	esc_attr__('Red','agencies'),
			'skyblue'		=>	esc_attr__('Sky Blue','agencies'),
			'teal'			=>	esc_attr__('Teal','agencies'),
			'turquoise'		=>	esc_attr__('Turquoise','agencies'),
			'wisteria'		=>	esc_attr__('Wisteria','agencies'),
			'yellow'		=>	esc_attr__('Yellow','agencies'),
		)
	));
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Primary Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 3,
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('primary-color'),
		'active_callback' => array(
		...
		'output' => array(
			...
			# Primary Color - Base	
			array( 'element' => 'a, h1 a:hover, h2 a:hover, h3 a:hover, h4 a:hover, h5 a:hover, h6 a:hover, .dt-sc-skin-highlight-color', 'property' => 'color' ),

			# Primary Color - Header
			array( 'element' => '.menu-icons-wrapper .search a:hover, .menu-icons-wrapper .cart a:hover, .breadcrumb a:hover', 'property' => 'color' ),
			...
			array( 'element' => '#footer a:hover, .left-header-footer .dt-sc-sociable.filled li a', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-icon-box.type1 .icon-wrapper .icon, .dt-sc-icon-box.type2 .icon-wrapper span, .dt-sc-icon-box.type4 .icon-wrapper span, .dt-sc-icon-box.type5:hover .icon-content h4 a, .dt-sc-icon-box.type5.no-icon-bg:hover .icon-wrapper span, .dt-sc-icon-box.type10 .icon-wrapper span, .dt-sc-icon-box.type10:hover .icon-content h4, .dt-sc-icon-box.type13 .icon-content h4, .dt-sc-icon-box.type14.dt-sc-skin-highlight .icon-wrapper span, .dt-sc-icon-box.type14.dt-sc-skin-highlight .icon-content h4', 'property' => 'color' ),
...
.menu-icons-wrapper.rounded-icons .search a span:hover, .menu-icons-wrapper.rounded-icons .cart a span:hover, .menu-icons-wrapper .cart sup', 'property' => 'background-color' ),
			...
			array( 'element' => 'ul.side-nav li a:hover:before, ul.side-nav > li.current_page_item > a:before, ul.side-nav > li > ul > li.current_page_item > a:before, ul.side-nav > li > ul > li > ul > li.current_page_item > a:before, .dt-sc-small-separator, .dt-sc-diamond-separator, .dt-sc-titled-box h6.dt-sc-titled-box-title, .carousel-arrows a:hover, .dt-sc-images-wrapper .carousel-arrows a:hover, .diamond-narrow-square-border li:hover:before, .dt-sc-sociable.hexagon-with-border li, .dt-sc-skin-highlight, .dt-sc-skin-highlight.dt-sc-dark-bg, .dt-sc-skin-highlight.extend-bg-fullwidth-left:after, .dt-sc-skin-highlight.extend-bg-fullwidth-right:after, .two-color-section:before, .dt-sc-readmore-plus-icon:hover:before, .dt-sc-readmore-plus-icon:hover:after, .dt-sc-contact-details-on-map .map-switch-icon, .dt-sc-content-with-hexagon-shape, .dt-sc-hexagons li .dt-sc-hexagon-overlay, .available-domains li .tdl:before, .available-domains li:hover .dt-sc-button, .domain-search-container .domain-search-form, .dt-sc-newsletter-section.type1 h2:before, .dt-sc-newsletter-section.type1 h2:after', 'property' => 'background-color' ),
			...
			# Primary BG - Counters
			array( 'element' => '.dt-sc-counter.type1 .dt-sc-counter-number:before, .dt-sc-counter.type2 .dt-sc-couter-icon-holder, .dt-sc-counter.type3:hover .icon-wrapper, .dt-sc-counter.type3.diamond-square .dt-sc-couter-icon-holder .icon-wrapper:before, .dt-sc-counter.type4:hover .dt-sc-couter-icon-holder, .dt-sc-counter.type5:hover:after, .dt-sc-counter.type6 h4:before, .dt-sc-counter.type6:hover .dt-sc-couter-icon-holder:before', 'property' => 'background-color' ),	

			# Primary BG Color - Icon Boxes
			array( 'element' => '.dt-sc-icon-box.type1 .icon-content h4:before, .dt-sc-icon-box.type3 .icon-wrapper span, .dt-sc-icon-box.type3.dt-sc-diamond:hover .icon-wrapper:after, .dt-sc-icon-box.type5.rounded-skin .icon-wrapper, .dt-sc-icon-box.type5.rounded:hover .icon-wrapper, .dt-sc-icon-box.type5:hover .icon-wrapper:before, .dt-sc-icon-box.type5.alter .icon-wrapper:before, .dt-sc-icon-box.type6 .icon-wrapper, .dt-sc-icon-box.type7 .icon-wrapper span, .dt-sc-contact-info.type8:hover span, .dt-sc-icon-box.type10:hover .icon-wrapper:before, .dt-sc-icon-box.type10 .icon-content h4:before, .dt-sc-icon-box.type11:before, .dt-sc-icon-box.type12.dt-sc-skin-highlight, .dt-sc-icon-box.type13:hover, .dt-sc-icon-box.type14.dt-sc-skin-highlight:hover', 'property' => 'background-color' ),
			...
			array( 'element' => '.live-chat a, .dt-bmi-inner-content tbody th, .dt-bmi-inner-content tbody tr:nth-child(2n+1) th, .dt-sc-menu .menu-categories a:before, .hotel-search-container form input[type="submit"]:hover, .hotel-search-container .selection-box:after, .dt-sc-training-details-overlay, .dt-sc-toggle-advanced-options span, #wpsl-search-btn, #wpsl-wrap .wpsl-selected-item, #wpsl-stores li > p span, #wpsl-stores .wpsl-directions', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-colored-big-buttons, .dt-sc-button.fully-rounded-border, .dt-sc-button.fully-rounded-border:hover, .dt-sc-button.rounded-border.black:hover, .dt-sc-button.bordered.black:hover, .dt-sc-button.bordered:hover, .dt-sc-button.rounded-border:hover, .dt-sc-button.filled.default:before, .dt-sc-button.filled.default:after', 'property' => 'border-color' ),
			...
			array( 'element' => '#tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option a:hover, #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option.tribe-bar-active a:hover, #tribe-bar-form .tribe-bar-submit input[type="submit"], #tribe-bar-views .tribe-bar-views-list li.tribe-bar-active a, .tribe-events-calendar thead th, #tribe-events-content .tribe-events-tooltip h4, .tribe-events-calendar td.tribe-events-present div[id*="tribe-events-daynum-"], .tribe-events-read-more, #tribe-events .tribe-events-button, .tribe-events-button, .tribe-events-calendar td.tribe-events-present div[id*="tribe-events-daynum-"] > a, .tribe-events-back > a, #tribe_events_filters_toggle, 
				...
				.tribe-grid-header, .tribe-grid-allday .tribe-events-week-allday-single, .tribe-grid-body .tribe-events-week-hourly-single, #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option a:hover, #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option.tribe-bar-active a:hover, #tribe-bar-form .tribe-bar-submit input[type="submit"], #tribe-bar-views .tribe-bar-views-list li.tribe-bar-active a, .tribe-events-calendar thead th, #tribe-events-content .tribe-events-tooltip h4, .tribe-events-calendar td.tribe-events-present div[id*="tribe-events-daynum-"], .tribe-events-read-more, #tribe-events .tribe-events-button, .tribe-events-button, .tribe-events-calendar td.tribe-events-present div[id*="tribe-events-daynum-"] > a, .tribe-events-back > a, #tribe_events_filters_toggle, .type5.tribe_events .nav-top-links a', 'property' => 'background-color' ),
			...
			array( 'element' => '.type1 .event-schedule, .type1.tribe_events .nav-top-links a:hover, .type1.tribe_events .event-image-wrapper .event-datetime > i, .type1.tribe_events .event-image-wrapper .event-venue > i, .type1.tribe_events h4 a, .type2.tribe_events .date-wrapper p span, .type2.tribe_events h4 a, .type3.tribe_events .right-calc a:hover, .type3.tribe_events .tribe-events-sub-nav li a:hover, .type3.tribe_events .tribe-events-sub-nav li a span, .type4.tribe_events .data-wrapper p span, .type4.tribe_events .data-wrapper p i, .type4.tribe_events .event-organize h4 a, .type4.tribe_events .event-venue h4 a, .type5.tribe_events .event-details h3, .type5.tribe_events .event-organize h3, .type5.tribe_events .event-venue h3, .type5.tribe_events .data-wrapper p span, .data-wrapper p i, .type5.tribe_events .event-organize h4 a, .type5.tribe_events .event-venue h4 a, .single-tribe_events a.tribe-events-gcal, .single-tribe_events a.tribe-events-ical', 'property' => 'color' ),


			# Primary BG Color - Event Listing Shortcode
			array( 'element' => '.dt-sc-event.type1 .dt-sc-event-thumb p, .dt-sc-event.type1 .dt-sc-event-meta:before, .dt-sc-event.type2:hover .dt-sc-event-meta, .dt-sc-event.type3 .dt-sc-event-date, .dt-sc-event.type3:hover .dt-sc-event-date, .dt-sc-event.type3:hover .dt-sc-event-meta', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-event.type1 .dt-sc-event-meta p span, .dt-sc-event.type1:hover h2.entry-title a, .dt-sc-event.type2 .dt-sc-event-date span, .dt-sc-event.type2:hover h2.entry-title a, .dt-sc-event.type3:hover h2.entry-title a, .dt-sc-event.type4 .dt-sc-event-date span, .dt-sc-event.type4 h2.entry-title a, .dt-sc-event.type4 .dt-sc-event-date i, .dt-sc-event.type5 .dt-sc-event-date span, .dt-sc-event.type5 .dt-sc-event-date i, .dt-sc-event.type5 .dt-sc-event-cost, .dt-sc-event.type5:hover h2.entry-title a', 'property' => 'color' ),
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Secondary Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 4,
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('secondary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			...
			array( 'element' => '#tribe-bar-form .tribe-bar-submit input[type="submit"]:hover, .tribe-events-read-more:hover, #tribe-events .tribe-events-button:hover, .tribe-events-button:hover, .tribe-events-back > a:hover, .datepicker thead tr:first-child th:hover, .datepicker tfoot tr th:hover, #tribe_events_filters_toggle:hover,

				#tribe-bar-form .tribe-bar-submit input[type="submit"]:hover, .tribe-events-read-more:hover, #tribe-events .tribe-events-button:hover, .tribe-events-button:hover, .tribe-events-back > a:hover, .datepicker thead tr:first-child th:hover, .datepicker tfoot tr th:hover, #tribe_events_filters_toggle:hover, .tribe-grid-allday .tribe-events-week-allday-single, .tribe-grid-body .tribe-events-week-hourly-single, .type5.tribe_events .nav-top-links a:hover', 'property' => 'background-color' ),

			# Secondary BG Color - Events Pro
			array( 'element' => '.tribe-grid-header .tribe-week-today, .tribe-events-grid .tribe-grid-header .tribe-week-today', 'property' => 'background-color' ),
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Tertiary Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 5,
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('tertiary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			# Tertiary BG Color - Miscellaneous/Shortcodes
			array( 'element' => '.portfolio.type1:before, .portfolio.type1:after, .portfolio.type1 figure:before, .portfolio.type1 figure:after, .dt-sc-triangle-title:before, .dt-sc-icon-box.type10 .icon-wrapper:after', 'property' => 'background-color' ),	

			# Tertiary Color - Miscellaneous/Shortcodes
			array( 'element' => '.dt-sc-icon-box.type5.no-icon-bg .icon-wrapper span', 'property' => 'color' ), 
			...
			array( 'element' => '.tribe-events-day .tribe-events-day-time-slot h5', 'property' => 'background-color' ),

			# Tertiary Border Color - Events
			array( 'element' => '.tribe-grid-allday .tribe-events-week-allday-single, .tribe-grid-body .tribe-events-week-hourly-single', 'property' => 'border-color' ),
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site BG Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => '
		...
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('body-bg-color'),
	));
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Content Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'body' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('body-content-color'),
	));
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('body-a-color'),
	));
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Hover Color', 'agencies' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a:hover' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => agencies_defaults('body-a-hover-color'),
	));					