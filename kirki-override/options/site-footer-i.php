...
# Footer I Layout
	AGENCIES_Kirki::add_section( 'dt_footer_layout', array(
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'choices' => array(
				'1' => get_template_directory_uri().'/kirki-override/assets/images/columns/one-column.png',
				'2' => get_template_directory_uri().'/kirki-override/assets/images/columns/one-half-column.png',
				'3' => get_template_directory_uri().'/kirki-override/assets/images/columns/one-third-column.png',
				'4' => get_template_directory_uri().'/kirki-override/assets/images/columns/one-fourth-column.png',
				'5' => get_template_directory_uri().'/kirki-override/assets/images/columns/one-fifth-column.png',
				'6' => get_template_directory_uri().'/kirki-override/assets/images/columns/one-sixth-column.png',

				'12' => get_template_directory_uri().'/kirki-override/assets/images/columns/onefourth-onefourth-onehalf-column.png',
				'13' => get_template_directory_uri().'/kirki-override/assets/images/columns/onehalf-onefourth-onefourth-column.png',
				'11' => get_template_directory_uri().'/kirki-override/assets/images/columns/onefourth-onehalf-onefourth-column.png',

				'7' => get_template_directory_uri().'/kirki-override/assets/images/columns/onefourth-threefourth-column.png',
				'8' => get_template_directory_uri().'/kirki-override/assets/images/columns/threefourth-onefourth-column.png',

				'9' => get_template_directory_uri().'/kirki-override/assets/images/columns/onethird-twothird-column.png',
				'10' => get_template_directory_uri().'/kirki-override/assets/images/columns/twothird-onethird-column.png',
			),
