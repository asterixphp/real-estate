...
# Header Settings
	AGENCIES_Kirki::add_section( 'dt_site_header_section', array(
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'choices' => array(
				'fullwidth-header' 				=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/fullwidth-header.jpg',
				'boxed-header' 					=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/boxed-header.jpg',
				'split-header boxed-header' 	=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/splitted-boxed-header.jpg',
				'split-header fullwidth-header' => get_template_directory_uri().'/kirki-override/assets/images/site-headers/splitted-fullwidth-header.jpg',
				'fullwidth-header header-align-center fullwidth-menu-header' 	=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/fullwidth-menu-center.jpg',
				'two-color-header' 			=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/two-color-header.jpg',			
				'fullwidth-header header-align-left fullwidth-menu-header' 		=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/fullwidth-menu-left.jpg',
				'left-header' 				=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/left-header.jpg',
				'left-header-boxed' 		=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/left-header-boxed.jpg',			
				'creative-header' 			=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/creative-header.jpg',
				'overlay-header' 			=> get_template_directory_uri().'/kirki-override/assets/images/site-headers/overlay-header.jpg',
			)
		));
