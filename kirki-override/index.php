<?php
require_once 'kirki-utils.php';
require_once 'kirki-fallback.php';
...
function agencies_enqueue_customizer_stylesheet() {
	wp_register_style( 'agencies-customizer-css', get_template_directory_uri().'/kirki-override/assets/css/customizer.css', NULL, NULL, 'all' );
...
function agencies_enqueue_customizer_script() {
	wp_register_script( 'agencies-customizer-js', get_template_directory_uri().'/kirki-override/assets/js/customizer.js', array('jquery', 'customize-controls' ), false, true );
...
AGENCIES_Kirki::add_config( $config , array(
	...
	# Site Layout
	require_once get_template_directory() . '/kirki-override/options/site-layout.php';

	# Site Skin
	require_once get_template_directory() . '/kirki-override/options/site-skin.php';
	...
	require_once get_template_directory() . '/kirki-override/options/site-breadcrumb.php';
	...
	require_once get_template_directory() . '/kirki-override/options/site-header.php';
	...
	require_once get_template_directory() . '/kirki-override/options/site-menu/navigation.php';		
	...
	# Site Footer I
		...
		require_once get_template_directory() . '/kirki-override/options/site-footer-i.php';
	...
	require_once get_template_directory() . '/kirki-override/options/site-footer-copyright.php';

	# Site Sociable
	require_once get_template_directory() . '/kirki-override/options/site-sociable.php';

	# Additional JS
	require_once get_template_directory() . '/kirki-override/options/custom-js.php';
	...
	require_once get_template_directory() . '/kirki-override/options/site-typography.php';	
