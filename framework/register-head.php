	...
	if( empty( $use_predefined_skin ) ) {
		...
		if( !empty( $primary_color ) ) {
			...
			if( function_exists( 'is_woocommerce' ) ){
				...
				$css .= '.woo-type8.woocommerce ul.products li.product:hover .product-content:after, .woo-type8 .woocommerce ul.products li.product:hover .product-content:after { border-color : rgba( '.$rgba.', 0.75 ) rgba('.$rgba.', 0.75 ) rgba(255, 255, 255, 0.35) rgba(255, 255, 255, 0.35) }';
